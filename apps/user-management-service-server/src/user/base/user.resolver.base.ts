...
export class UserResolverBase {
  ...
  @graphql.ResolveField(() => [OAuth], { name: "oAuths" })
  async findOAuths(
    @graphql.Parent() parent: User,
    @graphql.Args() args: OAuthFindManyArgs
  ): Promise<OAuth[]> {
    const results = await this.service.findOAuths(parent.id, args);
  ...
  async getParent(@graphql.Parent() parent: User): Promise<Parent | null> {
